...
<Title outline={blank} name={'Montreal'} location={'Regional Report'} bg={'https://i.imgur.com/SPNVRmc.jpeg'} />
...
<div class="full-text">
	...
	<p>Six million people live in the Toronto region, and 97.6% of them live within 1 km of a main street. Main streets have more than 32,000 businesses that employ 285,000 people and generate over $20 billion in revenue per year. There are also X sites of civic infrastructure on main streets that employ an additional X people. </p>
	<p>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>Among all 20 Toronto-region main streets, those in small towns were generally the most resilient, with Sutton and Caledon East leading the way. The most resilient neighbourhood main street was Thorncliffe Park, which had a high level of visitors (30%) coming from less than 1 km away. More car-oriented main streets such as those in Pickering, Markham, Scarborough, and Mississauga were less resilient and only drew between 9%–12% of their visitors from nearby. </p>
			<p>The least resilient main street was in Toronto’s Liberty Village neighbourhood. This Business Improvement Area is to the west of the city’s central business district and contains many high-tech employers. This industry continues to be at the forefront of the work-from-home trend. Liberty Village is also a relatively new residential neighbourhood that has lower levels of civic infrastructure (i.e., no school, library, recreation centre), especially relative to other central parts of the city. </p>
		</div>
	</div>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>Downtown Toronto is at the other end of the spectrum, with much higher levels of civic infrastructure, as it is home to many regionally significant assets. Fittingly, Downtown Yonge and Spadina-Chinatown are the case studies that score the highest on our Civic Infrastructure Index. The centres of many suburban communities and satellite towns also score well above the median. The main street case studies that are most exemplary in this respect are Oakville, Newmarket, and Markham. </p>
			<p>The core issue not only about the overall amount of civic infrastructure, but how it is geographically distributed within urban regions. There is a danger of creating “have and have-not” neighbourhoods with divergent levels of local access to civic infrastructure, which in turn decreases the amount of control residents with less access to civic infrastructure have over programming. In such a scenario, civic infrastructure is less responsive to specific neighbourhood needs. </p>
