...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>
				For our detailed resiliency analysis, we selected 20 main streets in the Toronto, Montreal, and Edmonton regions. These main streets were chosen to provide a representative sample of the types of streets in each regional context, and included four downtown (workplace-oriented), four small town, and 12 neighbourhood (residential-oriented) main streets. (More main streets were included in the neighbourhood category as there is a greater variety of main streets within this group.) In addition, we intentionally included main streets with equity-deserving communities. 			</p>
		</div>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>
				There was a clear geography to main street resiliency through the pandemic, with downtown main streets typically suffering the sharpest drop-offs in visitor levels and experiencing the slowest recoveries. 			</p>
				<ul>
					<li>North York Centre in Toronto was the most resilient downtown street among our case studies. This is likely due to its function as a secondary downtown to Toronto’s central core, with a significant residential population. </li>
					<li>The least resilient downtown main street was 97th Street in Edmonton, which saw visitor levels drop to 15% of pre-pandemic levels in October 2021, and rising only to 33% by the end of 2022. </li>
					<li>Small town main streets tended to be the most resilient, although there was an extensive range between the top (Sutton in the Toronto region) and the bottom (St. Eustache in the Montreal region). </li>
					<li>Neighbourhood main street resiliency was in between that of downtowns and small towns (closer to the latter). Rue Beaubien in Montreal was the most resilient neighbourhood main street; Central Brampton (Main and Queen) was the least resilient.</li>
				</ul>
		</div>
	</div>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>There is a clear pattern: infrequent visitors (workers) outnumbered local residents on downtown main streets prior to the pandemic. The opposite tends to be true for small towns and neighbourhood main streets that relied more heavily on residential visitors.</p>
		</div>
	</div>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>
				A core purpose of the initial Measuring Main Street project was to assess the role of civic infrastructure on main street resiliency. We created a civic infrastructure provision score for every main street in the country: the Civic Infrastructure Index. This metric combines the presence of civic infrastructure locations relative to the population density of an area. The civic infrastructure locations are weighted by how many people they employ, to account for scale of the facility. Downtown main streets tend to have the highest levels of civic infrastructure provisions, largely because they house facilities that offer central functions (main libraries, major performance theatres, city halls) rather than strictly cater to a local population. In the context of COVID-19, these facilities were not sufficient to enable downtown main streets to withstand the pandemic’s impacts on visitor levels. The connection between civic infrastructure and main street resiliency proved to be more nuanced.			</p>
		</div>
	</div>
...
<div class="slide">
	<div class="text-container sticky-content">
		<div class="report-text">
			...
			<p>
				To uncover the factors that help explain main street resiliency throughout the pandemic, we performed a correlation analysis with a wide range of indicators. The factors included variables of urban form, demographics, and street content. 			</p>
			<p>The analysis revealed two key indicators that had the closest associations with main street resiliency. First was the share of visitors that are local residents. During the pandemic, people tended to stay closer to home; they were less likely to travel to work or other locations further away. Main streets that relied more heavily on visitors from further away were more likely to experience sharper drop-offs and slower recoveries. Second was the presence of green spaces. While civic infrastructure generally did not predict higher resiliency, parks did. This makes intuitive sense, as people still had the core desire to congregate, but wanted to do so in a safe outdoor setting. This suggests that civic infrastructure is indeed important to the vitality of main streets and that data analysis in more “normal” times may reveal this to be the case.</p>
		</div>
	</div>
