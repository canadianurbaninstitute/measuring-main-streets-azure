		...
		blocks: [
			{
                ...
                infrastructure of neighbourhoods by supporting walkability, hosting locally owned businesses, and fostering a sense of place.</p>
                <p>Across the Greater Toronto Area (GTA), major transit investments are reshaping urban corridors at a pace and scale not seen in generations.
                ...
                oversized retail units, inactive frontages, and a dominance of chain tenants that limit adaptability, local economic diversity, and community life.</p>
                <p>This project responds to that gap by asking a central question: How can ground floors in newly densified, transit-oriented communities be designed
			...
			},
			{
                ...
                offers limited direction on how ground floors will be designed, programmed, and governed.</p>
				<p><b>This creates both a risk and a rare opportunity:</b> to shape the 
		...
		blocks: [
			{
				...
				body: `<p>In response, our team developed a practitioner-oriented Guidebook in partnership with the Canadian Urban Institute (CUI). The Guidebook
                ...
                are active, adaptable, and community-serving over time.</p>
                <p>Design recommendations are organized across macro, meso, and micro scales,
                ...
                and newcomer-owned businesses, and sustains community infrastructure through tools partnerships and community benefits agreements.</p>`
			},
			{
                ...
                as New York, London, Amsterdam, and Barcelona, to identify transferable strategies and avoid well-documented pitfalls.</p>
                <p><b>This Guidebook is a practical decision-support tool</b> for planners, developers, policymakers, and community organizations involved in the Golden Mile's
