...
export const sections = [
	{
		...
		blocks: [
			{
				eyebrow: 'Canada’s grocery oligopoly',
				heading: 'Runaway grocery prices',
				body: `<p>Canada’s grocery industry lacks healthy competition. Grocery prices have increased more than <a href="https://stories.td.com/ca/en/article/rising-cost-of-groceries-canada-td-economics" target="_blank">30% since late 2019</a>, and food affordability is becoming the <a href="https://www.cbc.ca/news/canada/nova-scotia/canadians-save-groceries-food-costs-survey-9.6986295" target="_blank">number one financial concern</a> for many Canadians. This trend represents market failure.</p>
				<p>In 2022, Canada’s grocery giants—Loblaws, Sobeys, and Metro—reported more than $100 billion in food sales and earned more than $3.6 billion in profits. The three giants actively block competition and are free to maximize profits at the expense of Canadians.</p>
				<p>When you include Walmart and Costco, these five corporations form an oligopoly, <a href="https://breachmedia.ca/why-canada-needs-public-grocery-stores/" target="_blank">controlling over 80 per cent</a> of the grocery market.</p>
				<p>The <a href="https://competition-bureau.canada.ca/sites/default/files/attachments/2023/CB-Retail-Grocery-Market-Study-Report-EN-2023-06-23.pdf" target="_blank">Competition Bureau of Canada</a> identifies more competition as key to bringing grocery prices down but warns that independent grocers won’t expand without government support.</p>`
			},
			{
		...
		panels: [
			{
				...
				label: 'Figure 2 – Urban transit networks and food access intensities',
	...
	},
	{
		panels: [
			{
				id: 'public-option',
				label: 'Figure 3 – Proposed Federal Investment in Public Grocers',
				source: 'Canadian Centre for Policy Alternatives (2026)'
			}
		],
		blocks: [
			{
