<script>
	...
	import businessmix from '../../../lib/data/casestudydata/toronto/schomberg/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/schomberg/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/schomberg/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/toronto/schomberg/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/toronto/schomberg/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/toronto/schomberg/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/schomberg/visitordayofweek';
...
<main>
	<Title outline={schomberg} name={'Main Street (Schomberg)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt36w51w001j01p55c8089ix'}
						center={[-79.684, 44.003]}
						zoom={15}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'schomberg', 'schomberg-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'schomberg'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt36w51w001j01p55c8089ix'}
						center={[-79.6839, 44.0026]}
						zoom={17}
						minZoom={14}
						pitch={40}
						bearing={-15}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['schomberg', 'schomberg-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['schomberg-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['schomberg-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['schomberg-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Main Street (Schomberg)'} location={'Toronto, Ontario'} />
</main>
