...
<main>
	<Title outline={kingstonroad} name={'Kingston Road'} location={'Toronto, Ontario'} />
	<div class="container">
			...
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						...
						center={[-79.2504, 43.7073]}
						zoom={13}
						pitch={35}
						bearing={-25}
						layers={['mainstreets-toronto', 'kingstonroad', 'kingstonroad-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['kingstonroad', 'kingstonroad-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['kingstonroad-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['kingstonroad-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['kingstonroad-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Kingston Road'} location={'Toronto, Ontario'} />
</main>
