<script>
	...
	import greenspace from '../../../lib/data/casestudydata/toronto/caledoneast/greenspace';
	import civicmix from '../../../lib/data/casestudydata/toronto/caledoneast/civicmix';
	import businessmix from '../../../lib/data/casestudydata/toronto/caledoneast/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/caledoneast/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/caledoneast/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/toronto/caledoneast/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/toronto/caledoneast/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/toronto/caledoneast/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/caledoneast/visitordayofweek';
...
<main>
	<Title outline={caledoneast} name={'Airport Road (Caledon East)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxkxcgw003601qp8zqwhm8r'}
						center={[-79.8661, 43.8687]}
						zoom={16}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'caledoneast', 'caledoneast-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'caledoneast'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxkxcgw003601qp8zqwhm8r'}
						center={[-79.8663, 43.8696]}
						zoom={17}
						minZoom={15}
						pitch={40}
						bearing={-15}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['caledoneast', 'caledoneast-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['caledoneast-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['caledoneast-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['caledoneast-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Airport Road (Caledon East)'} location={'Toronto, Ontario'} />
</main>
