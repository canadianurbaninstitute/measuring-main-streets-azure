<script>
	...
	import greenspace from '../../../lib/data/casestudydata/toronto/oakville/greenspace';
	import civicmix from '../../../lib/data/casestudydata/toronto/oakville/civicmix';
	import businessmix from '../../../lib/data/casestudydata/toronto/oakville/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/oakville/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/oakville/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/oakville/visitordayofweek';
...
<main>
	<Title outline={oakville} name={'Lakeshore Road West (Oakville)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt358sri00u801qf61uu1q45'}
						center={[-79.6714, 43.4431]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'oakville', 'oakville-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'oakville'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt358sri00u801qf61uu1q45'}
						center={[-79.6697, 43.4444]}
						zoom={15}
						minZoom={13}
						pitch={40}
						bearing={-15}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['oakville', 'oakville-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['oakville-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['oakville-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['oakville-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Lakeshore Road West (Oakville)'} location={'Toronto, Ontario'} />
</main>
