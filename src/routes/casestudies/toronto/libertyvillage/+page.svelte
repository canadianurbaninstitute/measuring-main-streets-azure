<script>
	...
	import greenspace from '../../../lib/data/casestudydata/toronto/libertyvillage/greenspace';
	import civicmix from '../../../lib/data/casestudydata/toronto/libertyvillage/civicmix';
	import businessmix from '../../../lib/data/casestudydata/toronto/libertyvillage/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/libertyvillage/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/libertyvillage/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/toronto/libertyvillage/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/toronto/libertyvillage/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/toronto/libertyvillage/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/libertyvillage/visitordayofweek';
...
<main>
	<Title outline={libertyvillage} name={'Liberty Street (Liberty Village)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxpu16a00zs01p6hmi309f5'}
						center={[-79.4211, 43.6358]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'libertyvillage', 'libertyvillage-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'libertyvillage'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxpu16a00zs01p6hmi309f5'}
						center={[-79.4203, 43.6377]}
						zoom={15}
						minZoom={13}
						pitch={40}
						bearing={-15}
				...
				<div class="content-container sticky-content">
					...
					<div class="controls">
						...
						<div class="checkbox">
							<IsochroneCheckbox
								section={'civicinfra'}
								layer={'libertyvillage-isochrone'}
								minZoom={13}
								maxZoom={13.3}
							/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['libertyvillage', 'libertyvillage-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['libertyvillage-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['libertyvillage-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['libertyvillage-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Liberty Street (Liberty Village)'} location={'Toronto, Ontario'} />
</main>
