<script>
	...
	import downtownbrampton from '../../../lib/assets/boundaries/torontoboundaries/Brampton.svg';

	import EmpSizeLegend from '../../../lib/assets/employmentsizelegend.svg';

	import Summary from '../../../lib/Summary.svelte';

	import greenspace from '../../../lib/data/casestudydata/toronto/downtownbrampton/greenspace';
	import civicmix from '../../../lib/data/casestudydata/toronto/downtownbrampton/civicmix';
	import businessmix from '../../../lib/data/casestudydata/toronto/downtownbrampton/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/downtownbrampton/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/downtownbrampton/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/toronto/downtownbrampton/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/toronto/downtownbrampton/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/toronto/downtownbrampton/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/downtownbrampton/visitordayofweek';
...
<main>
	<Title outline={downtownbrampton} name={'Main Street North (Downtown Brampton)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'Downtown Brampton'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxltzjx002u01qsdmjng85t'}
						center={[-79.7599, 43.6852]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'downtownbrampton', 'downtownbrampton-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'downtownbrampton'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxltzjx002u01qsdmjng85t'}
						center={[-79.7616, 43.6864]}
						zoom={15}
						minZoom={13}
						pitch={40}
						bearing={-15}
				...
				<div class="content-container sticky-content">
					...
					<div class="controls">
						...
						<div class="checkbox">
							<IsochroneCheckbox
								section={'civicinfra'}
								layer={'downtownbrampton-isochrone'}
								minZoom={13}
								maxZoom={13.3}
							/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['downtownbrampton', 'downtownbrampton-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['downtownbrampton-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['downtownbrampton-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['downtownbrampton-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Main Street North (Downtown Brampton)'} location={'Toronto, Ontario'} />
</main>
