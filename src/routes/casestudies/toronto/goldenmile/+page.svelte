<script>
	...
	import greenspace from '../../../lib/data/casestudydata/toronto/goldenmile/greenspace';
	import civicmix from '../../../lib/data/casestudydata/toronto/goldenmile/civicmix';
	import businessmix from '../../../lib/data/casestudydata/toronto/goldenmile/businessmix';
	import housingtype from '../../../lib/data/casestudydata/toronto/goldenmile/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/toronto/goldenmile/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/toronto/goldenmile/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/toronto/goldenmile/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/toronto/goldenmile/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/toronto/goldenmile/visitordayofweek';
...
<main>
	<Title outline={goldenmile} name={'Eglinton Avenue East (Golden Mile)'} location={'Toronto, Ontario'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxpb99700zj01p6c6kw2bu0'}
						center={[-79.2906, 43.726]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-toronto', 'goldenmile', 'goldenmile-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'goldenmile'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clsxpb99700zj01p6c6kw2bu0'}
						center={[-79.2955, 43.7254]}
						zoom={15}
						minZoom={13}
						pitch={60}
						bearing={56}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['goldenmile', 'goldenmile-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['goldenmile-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['goldenmile-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['goldenmile-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Eglinton Avenue East (Golden Mile)'} location={'Toronto, Ontario'} />
</main>
