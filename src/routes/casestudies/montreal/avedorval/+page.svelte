<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/avedorval/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/avedorval/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/avedorval/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/avedorval/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/avedorval/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/avedorval/visitordayofweek';
...
<main>
	...
	<LanguageSelector eng={'/casestudies/montreal/avedorval'} fr={'/casestudies/montreal-fr/avedorval-fr'} selected='eng'/>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'avedorval'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3dnd45026t01p402sx9lh5'}
						center={[-73.742, 45.443]}
