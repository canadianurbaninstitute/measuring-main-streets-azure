<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/jeantalon/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/jeantalon/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/jeantalon/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/jeantalon/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/jeantalon/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/jeantalon/visitordayofweek';
...
<main>
	...
	<LanguageSelector eng={'/casestudies/montreal/jeantalon'} fr={'/casestudies/montreal-fr/jeantalon-fr'} selected='eng'/>
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3g4eyh027w01p4de5h6mhp'}
						center={[-73.624, 45.526]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'jeantalon', 'jeantalon-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'jeantalon'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3g4eyh027w01p4de5h6mhp'}
						center={[-73.6242, 45.527]}
						zoom={15}
						minZoom={13}
						pitch={40}
						bearing={-15}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['jeantalon', 'jeantalon-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['jeantalon-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['jeantalon-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['jeantalon-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Jean Talon (Parc-Extension)'} location={'Montreal, Québec'} />
</main>
