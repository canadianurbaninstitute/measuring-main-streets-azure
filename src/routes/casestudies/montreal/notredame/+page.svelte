<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/notredame/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/notredame/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/notredame/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/notredame/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/notredame/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/notredame/visitordayofweek';
...
<main>
	...
	<LanguageSelector eng={'/casestudies/montreal/notredame'} fr={'/casestudies/montreal-fr/notredame-fr'} selected='eng'/>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'notredame'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3hbk9p026l01p66bcq295s'}
