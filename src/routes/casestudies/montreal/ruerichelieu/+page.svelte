...
<main>
	<Title outline={ruerichelieu} name={'Rue Richelieu'} location={'Montreal, Québec'} />
	<div class="container">
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'ruerichelieu'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4i3osn02gh01qjbo3l7ej2'}
						center={[-73.251, 45.307]}
	...
	<Summary name={'Rue Richelieu'} location={'Montreal, Québec'} />
</main>
