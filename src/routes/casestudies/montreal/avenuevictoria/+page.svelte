<script>
	...
	import avenuevictoria from '../../../lib/assets/boundaries/montrealboundaries/AveVictoria.svg';

	import EmpSizeLegend from '../../../lib/assets/employmentsizelegend.svg';

	import Summary from '../../../lib/Summary.svelte';

	import greenspace from '../../../lib/data/casestudydata/montreal/avenuevictoria/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/avenuevictoria/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/avenuevictoria/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/avenuevictoria/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/avenuevictoria/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal/avenuevictoria/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal/avenuevictoria/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal/avenuevictoria/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/avenuevictoria/visitordayofweek';
...
<main>
	<Title outline={avenuevictoria} name={'Avenue Victoria (Saint Lambert)'} location={'Montreal, Québec'} />
	<LanguageSelector eng={'/casestudies/montreal/avenuevictoria'} fr={'/casestudies/montreal-fr/avenuevictoria-fr'} selected='eng'/>
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'Avenue Victoria'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3ehlus00yl01qf6i1ubz0g'}
						center={[-73.497, 45.492]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'avenuevictoria', 'avenuevictoria-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'avenuevictoria'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3ehlus00yl01qf6i1ubz0g'}
						center={[-73.497, 45.492]}
				...
				<div class="content-container sticky-content">
					...
					<div class="controls">
						...
						<div class="checkbox">
							<IsochroneCheckbox
								section={'civicinfra'}
								layer={'avenuevictoria-isochrone'}
								minZoom={13}
								maxZoom={13.3}
							/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avenuevictoria', 'avenuevictoria-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avenuevictoria-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avenuevictoria-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avenuevictoria-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Avenue Victoria (Saint Lambert)'} location={'Montreal, Québec'} />
</main>
