<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/steustache/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/steustache/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/steustache/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/steustache/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/steustache/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/steustache/visitordayofweek';
...
<main>
	...
	<LanguageSelector eng={'/casestudies/montreal/steustache'} fr={'/casestudies/montreal-fr/steustache-fr'} selected='eng'/>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'steustache'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4iyci202fn01p66t9422jj'}
						center={[-73.893, 45.558]}
