<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/sthubert/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/sthubert/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/sthubert/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/sthubert/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/sthubert/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal/sthubert/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal/sthubert/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal/sthubert/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/sthubert/visitordayofweek';
...
<main>
	<Title outline={sthubert} name={'Rue St. Hubert (Plaza Saint Hubert)'} location={'Montreal, Québec'} />
	<LanguageSelector eng={'/casestudies/montreal/sthubert'} fr={'/casestudies/montreal-fr/sthubert-fr'} selected='eng'/>
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4jkgn102gm01qj7fdjbjcd'}
						center={[-73.6088, 45.5377]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'sthubert', 'sthubert-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'sthubert'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4jkgn102gm01qj7fdjbjcd'}
						center={[-73.6055, 45.5375]}
						zoom={15}
						minZoom={13}
						pitch={55}
						bearing={-55}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['sthubert', 'sthubert-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['sthubert-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['sthubert-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['sthubert-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Rue St. Hubert (Plaza Saint Hubert)'} location={'Montreal, Québec'} />
</main>
