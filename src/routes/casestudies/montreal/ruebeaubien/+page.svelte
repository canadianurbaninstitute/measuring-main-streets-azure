<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal/ruebeaubien/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal/ruebeaubien/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal/ruebeaubien/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal/ruebeaubien/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal/ruebeaubien/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal/ruebeaubien/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal/ruebeaubien/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal/ruebeaubien/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal/ruebeaubien/visitordayofweek';
...
<main>
	<Title outline={ruebeaubien} name={'Rue Beaubien'} location={'Montreal, Québec'} />
	<div class="container">
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'ruebeaubien'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4gf0ee02f801p60umt1pq9'}
						center={[-73.593, 45.546]}
	...
	<Summary name={'Rue Beaubien'} location={'Montreal, Québec'} />
</main>
