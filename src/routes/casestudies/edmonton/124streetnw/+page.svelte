<script>
	...
	import housingtype from '../../../lib/data/casestudydata/edmonton/124streetnw/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/124streetnw/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/124streetnw/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/124streetnw/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/124streetnw/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/124streetnw/visitordayofweek';
			...
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						...
						center={[-113.536, 53.554]}
						zoom={13}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', '124streetnw', '124streetnw-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['124streetnw', '124streetnw-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['124streetnw-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['124streetnw-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['124streetnw-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
