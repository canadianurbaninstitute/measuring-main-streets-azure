...
<main>
	<Title outline={HundredEighteenAlbertaAve} name={'118 Ave (Alberta Avenue)'} location={'Edmonton, Alberta'} />
	<div class="container">
	...
	<Summary name={'118 Ave (Alberta Avenue)'} location={'Edmonton, Alberta'} />
</main>
