<script>
	...
	import greenspace from '../../../lib/data/casestudydata/edmonton/137avenuenw/greenspace';
	import civicmix from '../../../lib/data/casestudydata/edmonton/137avenuenw/civicmix';
	import businessmix from '../../../lib/data/casestudydata/edmonton/137avenuenw/businessmix';
	import housingtype from '../../../lib/data/casestudydata/edmonton/137avenuenw/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/137avenuenw/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/137avenuenw/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/137avenuenw/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/137avenuenw/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/137avenuenw/visitordayofweek';
...
<main>
	<Title outline={HundredThirtySevenAvenueNW} name={'137 Avenue NW (North Edmonton)'} location={'Edmonton, Alberta'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4tl1tj000z01qmd15lhj19'}
						center={[-113.5549, 53.5994]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', '137avenuenw', '137avenuenw-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'137avenuenw'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4tl1tj000z01qmd15lhj19'}
						center={[-113.5606, 53.5993]}
						zoom={15}
						minZoom={15}
						pitch={60}
						bearing={60}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['137avenuenw', '137avenuenw-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['137avenuenw-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['137avenuenw-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['137avenuenw-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'137 Avenue NW (North Edmonton)'} location={'Edmonton, Alberta'} />
</main>
