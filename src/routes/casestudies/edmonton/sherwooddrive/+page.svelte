<script>
	...
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/sherwooddrive/housingconstruction';
	import housingtype from '../../../lib/data/casestudydata/edmonton/sherwooddrive/housingtype';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/sherwooddrive/visitordayofweek';
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'Sherwood Drive'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4unoun02it01qj9d287ue5'}
						center={[-113.2962, 53.5256]}
						zoom={15}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', 'sherwooddrive', 'sherwooddrive-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'sherwooddrive'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4unoun02it01qj9d287ue5'}
						center={[-113.2962, 53.5256]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['sherwooddrive', 'sherwooddrive-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['sherwooddrive-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['sherwooddrive-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['sherwooddrive-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
