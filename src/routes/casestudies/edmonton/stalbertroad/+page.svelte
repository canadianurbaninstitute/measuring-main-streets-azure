<script>
	...
	import greenspace from '../../../lib/data/casestudydata/edmonton/stalbertroad/greenspace';
	import civicmix from '../../../lib/data/casestudydata/edmonton/stalbertroad/civicmix';
	import businessmix from '../../../lib/data/casestudydata/edmonton/stalbertroad/businessmix';
	import housingtype from '../../../lib/data/casestudydata/edmonton/stalbertroad/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/stalbertroad/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/stalbertroad/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/stalbertroad/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/stalbertroad/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/stalbertroad/visitordayofweek';
...
<main>
	<Title outline={StAlbertRoad} name={'St. Albert Road'} location={'Edmonton, Alberta'} />
	<div class="container">
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'St. Albert Road'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4vf1i0001g01qmg5k12njv'}
						center={[-113.6182, 53.6272]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', 'stalbertroad', 'stalbertroad-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'stalbertroad'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4vf1i0001g01qmg5k12njv'}
						center={[-113.6164, 53.6247]}
						zoom={15}
						minZoom={15}
						pitch={60}
						bearing={15}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['stalbertroad', 'stalbertroad-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['stalbertroad-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['stalbertroad-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['stalbertroad-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'St. Albert Road'} location={'Edmonton, Alberta'} />
</main>
