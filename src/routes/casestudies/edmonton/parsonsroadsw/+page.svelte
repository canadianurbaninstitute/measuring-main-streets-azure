<script>
	...
	import greenspace from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/greenspace';
	import civicmix from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/civicmix';
	import businessmix from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/businessmix';
	import housingtype from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/parsonsroadsw/visitordayofweek';
...
<main>
	<Title outline={ParsonsRoadSW} name={'Parsons Road SW'} location={'Edmonton, Alberta'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'Parsons Road SW'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4tz21q02ht01p69pgz7l4y'}
						center={[-113.482, 53.4321]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', 'parsonsroadsw', 'parsonsroadsw-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'parsonsroadsw'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4tz21q02ht01p69pgz7l4y'}
						center={[-113.482, 53.4321]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['parsonsroadsw', 'parsonsroadsw-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['parsonsroadsw-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['parsonsroadsw-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['parsonsroadsw-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Parsons Road SW'} location={'Edmonton, Alberta'} />
</main>
