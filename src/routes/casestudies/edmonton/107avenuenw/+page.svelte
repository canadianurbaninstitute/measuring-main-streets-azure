<script>
	...
	import greenspace from '../../../lib/data/casestudydata/edmonton/107avenuenw/greenspace';
	import civicmix from '../../../lib/data/casestudydata/edmonton/107avenuenw/civicmix';
	import businessmix from '../../../lib/data/casestudydata/edmonton/107avenuenw/businessmix';
	import housingtype from '../../../lib/data/casestudydata/edmonton/107avenuenw/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/107avenuenw/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/107avenuenw/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/107avenuenw/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/107avenuenw/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/107avenuenw/visitordayofweek';
...
<main>
	<Title outline={HundredSevenAvenueNW} name={'107 Avenue NW (Central McDougall)'} location={'Edmonton, Alberta'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4t09lf02if01qjf0gl4tg7'}
						center={[-113.4974, 53.5513]}
						zoom={15}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', '107avenuenw', '107avenuenw-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'107avenuenw'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4t09lf02if01qjf0gl4tg7'}
						center={[-113.4974, 53.5513]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['107avenuenw', '107avenuenw-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['107avenuenw-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['107avenuenw-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['107avenuenw-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'107 Avenue NW (Central McDougall)'} location={'Edmonton, Alberta'} />
</main>
