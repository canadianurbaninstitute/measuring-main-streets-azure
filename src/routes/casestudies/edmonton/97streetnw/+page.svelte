<script>
	...
	import NinetySevenStreetNW from '../../../lib/assets/boundaries/edmontonboundaries/97StreetNW.svg';

	import EmpSizeLegend from '../../../lib/assets/employmentsizelegend.svg';

	import Summary from '../../../lib/Summary.svelte';

	import greenspace from '../../../lib/data/casestudydata/edmonton/97streetnw/greenspace';
	import civicmix from '../../../lib/data/casestudydata/edmonton/97streetnw/civicmix';
	import businessmix from '../../../lib/data/casestudydata/edmonton/97streetnw/businessmix';
	import housingtype from '../../../lib/data/casestudydata/edmonton/97streetnw/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/edmonton/97streetnw/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/edmonton/97streetnw/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/edmonton/97streetnw/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/edmonton/97streetnw/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/edmonton/97streetnw/visitordayofweek';
...
<main>
	<Title outline={NinetySevenStreetNW} name={'97 Street NW (Northgate)'} location={'Edmonton, Alberta'} />
	<div class="container">
...
The map displays the boundaries of the case study, overlaid on the main street network. </p>
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4qcupf02iu01p4hk2g6cqx'}
						center={[-113.491, 53.5904]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', '97streetnw', '97streetnw-fill']}
						section={'overview'}
					/>
				</div>
			</div>
...
<h2>Built Form</h2>
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'97streetnw'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4qcupf02iu01p4hk2g6cqx'}
						center={[-113.4914, 53.5889]}
						zoom={15}
						minZoom={15}
						pitch={60}
						bearing={0}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetnw', '97streetnw-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetnw-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetnw-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetnw-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'97 Street NW (Northgate)'} location={'Edmonton, Alberta'} />
</main>
