...
<main>
	<Title outline={NinetySevenStreetDowntown} name={'97 Street Downtown'} location={'Edmonton, Alberta'} />
	<div class="container">
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<LegendItem
							variant={'polygon'}
							label={'97 Street Downtown'}
							bgcolor={'#ffdd33'}
							bordercolor={'#c4ad37'}
						/>
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4oitef02gr01p65vlub34u'}
						center={[-113.4866, 53.5433]}
						zoom={15}
						pitch={50}
						bearing={0}
						layers={['mainstreets-edmonton', '97streetdowntown', '97streetdowntown-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckbox casestudy={'97streetdowntown'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4oitef02gr01p65vlub34u'}
						center={[-113.4866, 53.5433]}
				...
				<div class="content-container sticky-content">
					...
					<div class="controls">
						...
						<div class="checkbox">
							<IsochroneCheckbox
								section={'civicinfra'}
								layer={'97streetdowntown-isochrone'}
								minZoom={13}
								maxZoom={13.3}
							/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetdowntown', '97streetdowntown-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetdowntown-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetdowntown-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={0}
						layers={['97streetdowntown-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'97 Street Downtown'} location={'Edmonton, Alberta'} />
</main>
