<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/ruerichelieu/visitordayofweek';
...
<main>
	...
	/>
	<LanguageSelector eng={'/casestudies/montreal/ruerichelieu'} fr={'/casestudies/montreal-fr/ruerichelieu-fr'} selected='fr'/>
		...
		<section data-id="map1">
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4i3osn02gh01qjbo3l7ej2'}
						center={[-73.251, 45.307]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'ruerichelieu', 'ruerichelieu-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'ruerichelieu'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4i3osn02gh01qjbo3l7ej2'}
						center={[-73.251, 45.307]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruerichelieu', 'ruerichelieu-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruerichelieu-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruerichelieu-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruerichelieu-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Rue Richelieu (Saint Jean sur Richelieu)'} location={'Montreal, Québec'} />
</main>
