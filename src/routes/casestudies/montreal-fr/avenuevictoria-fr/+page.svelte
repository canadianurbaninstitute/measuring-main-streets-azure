<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/avenuevictoria/visitordayofweek';
...
<main>
	<Title
		outline={avenuevictoria}
		name={'Avenue Victoria (Saint Lambert)'}
		location={'Montreal, Québec'}
	/>
	<LanguageSelector eng={'/casestudies/montreal/avenuevictoria'} fr={'/casestudies/montreal-fr/avenuevictoria-fr'} selected='fr'/>
	<div class="container">
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'avenuevictoria'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3ehlus00yl01qf6i1ubz0g'}
						center={[-73.497, 45.492]}
