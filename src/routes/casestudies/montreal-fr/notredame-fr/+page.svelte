<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/notredame/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/notredame/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/notredame/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/notredame/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/notredame/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal-fr/notredame/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal-fr/notredame/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal-fr/notredame/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/notredame/visitordayofweek';
...
<main>
	<Title outline={notredame} name={'Notre Dame (Saint Henri)'} location={'Montreal, Québec'} />
	<LanguageSelector eng={'/casestudies/montreal/notredame'} fr={'/casestudies/montreal-fr/notredame-fr'} selected='fr'/>
	<div class="container">
		<section data-id="map1">
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3hbk9p026l01p66bcq295s'}
						center={[-73.582, 45.477]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'notredame', 'notredame-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'notredame'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3hbk9p026l01p66bcq295s'}
						center={[-73.5861, 45.4741]}
						zoom={15}
						minZoom={13}
						pitch={55}
						bearing={30}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['notredame', 'notredame-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['notredame-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['notredame-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['notredame-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Notre Dame (Saint Henri)'} location={'Montreal, Québec'} />
</main>
