<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/avedorval/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/avedorval/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/avedorval/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/avedorval/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/avedorval/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/avedorval/visitordayofweek';
...
<main>
	<Title outline={avedorval} name={'Avenue Dorval'} location={'Montreal, Québec'} />
	<LanguageSelector eng={'/casestudies/montreal/avedorval'} fr={'/casestudies/montreal-fr/avedorval-fr'} selected='fr'/>
	<div class="container">
		<section data-id="map1">
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3dnd45026t01p402sx9lh5'}
						center={[-73.742, 45.443]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'avedorval', 'avedorval-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'avedorval'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt3dnd45026t01p402sx9lh5'}
						center={[-73.742, 45.443]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avedorval', 'avedorval-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avedorval-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avedorval-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['avedorval-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Avenue Dorval'} location={'Montreal, Québec'} />
</main>
