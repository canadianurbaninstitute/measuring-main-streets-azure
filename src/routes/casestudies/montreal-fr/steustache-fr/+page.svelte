<script>
	...
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/steustache/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/steustache/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal-fr/steustache/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal-fr/steustache/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal-fr/steustache/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/steustache/visitordayofweek';
...
<main>
	<Title outline={steustache} name={'St. Eustache'} location={'Montreal, Québec'} />
	<LanguageSelector eng={'/casestudies/montreal/steustache'} fr={'/casestudies/montreal-fr/steustache-fr'} selected='fr'/>
		...
		<section data-id="map1">
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4iyci202fn01p66t9422jj'}
						center={[-73.893, 45.558]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'steustache', 'steustache-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'steustache'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4iyci202fn01p66t9422jj'}
						center={[-73.893, 45.558]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['steustache', 'steustache-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['steustache-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['steustache-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['steustache-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
