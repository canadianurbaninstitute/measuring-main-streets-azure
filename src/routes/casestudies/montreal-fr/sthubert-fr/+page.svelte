<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/sthubert/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/sthubert/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/sthubert/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/sthubert/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/sthubert/housingconstruction';
	...
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/sthubert/visitordayofweek';
...
<main>
	...
	/>
	<LanguageSelector eng={'/casestudies/montreal/sthubert'} fr={'/casestudies/montreal-fr/sthubert-fr'} selected='fr'/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'sthubert'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4jkgn102gm01qj7fdjbjcd'}
