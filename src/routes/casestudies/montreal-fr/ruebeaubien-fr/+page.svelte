<script>
	...
	import greenspace from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/greenspace';
	import civicmix from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/civicmix';
	import businessmix from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/businessmix';
	import housingtype from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/housingtype';
	import housingconstruction from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/housingconstruction';
	import visitortraffic from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/visitortraffic';
	import visitortypes from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/visitortypes';
	import visitortimeofday from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/visitortimeofday';
	import visitordayofweek from '../../../lib/data/casestudydata/montreal-fr/ruebeaubien/visitordayofweek';
...
<main>
	...
	/>
	<LanguageSelector eng={'/casestudies/montreal/ruebeaubien'} fr={'/casestudies/montreal-fr/ruebeaubien-fr'} selected='fr'/>
	<div class="container">
		<section data-id="map1">
			<div class="section-container">
				...
				<div class="map-container">
					...
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4gf0ee02f801p60umt1pq9'}
						center={[-73.593, 45.546]}
						zoom={14}
						pitch={50}
						bearing={0}
						layers={['mainstreets-montreal', 'ruebeaubien', 'ruebeaubien-fill']}
						section={'overview'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<div class="legend-container">
						...
						<SatelliteCheckboxFr casestudy={'ruebeaubien'} section={'builtform'} />
					</div>
					<CaseStudyMap
						style={'mapbox://styles/canadianurbaninstitute/clt4gf0ee02f801p60umt1pq9'}
						center={[-73.593, 45.546]}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruebeaubien', 'ruebeaubien-fill', 'employment-size']}
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruebeaubien-outline', 'populationdensity']}
						section={'housing'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruebeaubien-outline', 'average-age']}
						section={'demographics'}
					/>
				</div>
			</div>
			...
			<div class="section-container">
				...
				<div class="map-container">
					<CaseStudyMap
						...
						pitch={0}
						bearing={-15}
						layers={['ruebeaubien-outline', 'visitors-2022']}
						section={'visitors'}
						attribution={'Canadian Urban Institute | Data Source: Environics Analytics'}
					/>
					<div class="legend-container">
	...
	<Summary name={'Rue Beaubien (Rosement-La-Petit-Patrie)'} location={'Montreal, Québec'} />
</main>
